...
function Menu() {
    ...
    return (
        <Drawer.Navigator
            screenOptions={{ headerTitle: "VistaCovid" }}
            drawerContent={(props) => {
                return (
                    <DrawerContentScrollView>
                        {role === "doctor" && (
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(q, (querySnapshot) => {
            querySnapshot.forEach((doc) => {
                ...
                if (
                    DetectDanger(60, 100, room.heartRate) ||
                    DetectDanger(10, 100, room.respirationRate) ||
                    DetectDanger(10, 100, room.oxygenLevel)
                ) {
    ...
    return (
        <Tab.Navigator tabBarPosition="bottom">
            ...
            <Tab.Screen
                ...
                options={{ tabBarIcon: () => <Icon name="person" size={25} /> }}
            />
        </Tab.Navigator>
    );
}
