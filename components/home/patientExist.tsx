...
export const ExistingPatient = (props: existingPatientProps) => {
    return (
        <View>
            <View>
                <Text style={{ fontSize: 20, paddingBottom: 5, marginTop: 40 }}>
                    Patient:
                </Text>
                <View
                    style={{
                ...
                <Text style={{ fontSize: 20, paddingBottom: 5, marginTop: 25 }}>
                    Room:
                </Text>
            ...
            <View style={{ marginTop: 10 }}>
                <Text>Responsible: {auth.currentUser ? auth.currentUser.displayName : 'SHEES'}</Text>
            </View>
            <View
                style={{
                    flexDirection: "row",
